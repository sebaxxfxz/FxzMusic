...
import com.fxzmusic.innertube.NewPipeExtractor
import com.fxzmusic.innertube.YouTube
import com.fxzmusic.innertube.models.YouTubeClient
import com.fxzmusic.innertube.models.YouTubeClient.Companion.ANDROID_CREATOR
import com.fxzmusic.ytpipeline.BotDetectionMitigator
import com.fxzmusic.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_43_32
import com.fxzmusic.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_61_48
import com.fxzmusic.innertube.models.YouTubeClient.Companion.ANDROID_VR_NO_AUTH
import com.fxzmusic.innertube.models.YouTubeClient.Companion.IOS
import com.fxzmusic.innertube.models.YouTubeClient.Companion.IPADOS
import com.fxzmusic.innertube.models.YouTubeClient.Companion.MOBILE
import com.fxzmusic.innertube.models.YouTubeClient.Companion.TVHTML5
...
import com.fxzmusic.innertube.models.YouTubeClient.Companion.WEB_CREATOR
...
import com.fxzmusic.ytpipeline.YTPlayerUtils.MAIN_CLIENT
import com.fxzmusic.ytpipeline.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.fxzmusic.ytpipeline.YTPlayerUtils.validateStatus
import com.fxzmusic.ytpipeline.potoken.PoTokenGenerator
import com.fxzmusic.ytpipeline.potoken.PoTokenResult
import com.fxzmusic.ytpipeline.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        Timber.tag(TAG).d("playerResponseForPlayback: videoId=$videoId, quality=$audioQuality, cookie=${YouTube.cookie != null}, visitorData=${YouTube.visitorData != null}")
        val showFallbackToast = showAudioFallbackToast

        var hasShownLosslessToast = false
        var hasShownOpusToast = false

        suspend fun tryOpus(): Result<PlaybackData> {
            Timber.tag(TAG).d("tryOpus: videoId=$videoId, quality=$audioQuality")
            val firstAttempt = resolvePlaybackData(videoId, playlistId, audioQuality, connectivityManager)
            Timber.tag(TAG).d("tryOpus: firstAttempt.isSuccess=${firstAttempt.isSuccess}")
            firstAttempt.onFailure { Timber.tag(TAG).e(it, "tryOpus: first attempt FAILED: ${it.message}") }
            if (firstAttempt.isFailure && YouTube.cookie == null) {
                ...
                Timber.tag(TAG).d("tryOpus: retryResult.isSuccess=${retryResult.isSuccess}")
            ...
            try {
                attemptResult = kotlinx.coroutines.withTimeoutOrNull(15000L) {
                    ...
                    if (title != null && author != null) {
                        val track = com.fxzmusic.ytpipeline.LosslessAPI.search(title, author)
                        if (track != null) {
                            val format = com.fxzmusic.innertube.models.response.PlayerResponse.StreamingData.Format(
                                itag = 0,
    ...
    suspend fun playerResponseForMetadata(
        ...
        return YouTube.player(videoId, playlistId, WEB_REMIX, null, null) 
    ...
    private fun findFormat(
        ...
        val audioFormats = adaptive.filter { it.isAudio }
