package com.fxzmusic.innertube

import com.fxzmusic.innertube.models.AccountInfo
...
import com.fxzmusic.innertube.models.MediaInfo
...
import com.fxzmusic.innertube.models.MusicCarouselShelfRenderer
import com.fxzmusic.innertube.models.MusicShelfRenderer
import com.fxzmusic.innertube.models.SectionListRenderer
import com.fxzmusic.innertube.models.PlaylistItem
import com.fxzmusic.innertube.models.SearchSuggestions
...
import com.fxzmusic.innertube.models.YouTubeClient
import com.fxzmusic.innertube.models.YouTubeClient.Companion.ANDROID_MUSIC
import com.fxzmusic.innertube.models.YouTubeClient.Companion.IOS
import com.fxzmusic.innertube.models.YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER
import com.fxzmusic.innertube.models.YouTubeClient.Companion.WEB
import com.fxzmusic.innertube.models.YouTubeClient.Companion.WEB_REMIX
import com.fxzmusic.innertube.models.YouTubeLocale
import com.fxzmusic.innertube.models.extractCountText
import com.fxzmusic.innertube.models.getContinuation
import com.fxzmusic.innertube.models.getItems
import com.fxzmusic.innertube.models.oddElements
import com.fxzmusic.innertube.models.response.AccountMenuResponse
import com.fxzmusic.innertube.models.response.BrowseResponse
import com.fxzmusic.innertube.models.response.CreatePlaylistResponse
import com.fxzmusic.innertube.models.response.EditPlaylistResponse
import com.fxzmusic.innertube.models.response.FeedbackResponse
import com.fxzmusic.innertube.models.response.GetQueueResponse
import com.fxzmusic.innertube.models.response.GetSearchSuggestionsResponse
import com.fxzmusic.innertube.models.response.GetTranscriptResponse
import com.fxzmusic.innertube.models.response.ImageUploadResponse
import com.fxzmusic.innertube.models.response.NextResponse
import com.fxzmusic.innertube.models.response.PlayerResponse
import com.fxzmusic.innertube.models.response.PipedResponse
import com.fxzmusic.innertube.models.response.SearchResponse
import com.fxzmusic.innertube.models.comment.CommentThreadRenderer
import com.fxzmusic.innertube.models.comment.CommentResponse
import com.fxzmusic.innertube.pages.AlbumPage
import com.fxzmusic.innertube.pages.ArtistItemsContinuationPage
import com.fxzmusic.innertube.pages.ArtistItemsPage
...
import com.fxzmusic.innertube.pages.LibraryContinuationPage
import com.fxzmusic.innertube.pages.LibraryPage
import com.fxzmusic.innertube.pages.MoodAndGenres
import com.fxzmusic.innertube.pages.NewReleaseAlbumPage
import com.fxzmusic.innertube.pages.NextPage
import com.fxzmusic.innertube.pages.NextResult
import com.fxzmusic.innertube.pages.PlaylistContinuationPage
import com.fxzmusic.innertube.pages.PlaylistPage
import com.fxzmusic.innertube.pages.RelatedPage
import com.fxzmusic.innertube.pages.SearchPage
import com.fxzmusic.innertube.pages.SearchResult
import com.fxzmusic.innertube.pages.SearchSuggestionPage
...
object YouTube {
    ...
    var ipVersion: com.fxzmusic.innertube.models.IpVersion
    ...
    suspend fun album(browseId: String, withSongs: Boolean = true): Result<AlbumPage> = runCatching {
        ...
        if (browseId.contains("FEmusic_library_privately_owned_release_detail")) {
            ...
            val albumItem = AlbumItem(
                ...
                thumbnail = response.contents.twoColumnBrowseResultsRenderer.tabs.firstOrNull()?.tabRenderer?.content?.sectionListRenderer?.contents?.firstOrNull()?.musicResponsiveHeaderRenderer?.thumbnail?.musicThumbnailRenderer?.thumbnail.getHighResUrl()!!,
                explicit = false, 
                description = description
            )
            return@runCatching AlbumPage(
    ...
    suspend fun playlist(playlistId: String): Result<PlaylistPage> = runCatching {
        ...
        PlaylistPage(
            playlist = PlaylistItem(
                ...
                thumbnail = header?.thumbnail?.musicThumbnailRenderer?.thumbnail.getHighResUrl() ?: "",
                playEndpoint = null,
    ...
    suspend fun player(videoId: String, playlistId: String? = null): Result<PlayerResponse> = runCatching {
        ...
        if (this.cookie != null) {
            playerResponse = innerTube.player(ANDROID_MUSIC, videoId, playlistId, null, null).body<PlayerResponse>()
            if (playerResponse.playabilityStatus.status == "OK") {
                return@runCatching playerResponse
            }
        }

        playerResponse = innerTube.player(IOS, videoId, playlistId, null, null).body<PlayerResponse>()
        if (playerResponse.playabilityStatus.status == "OK") {
            return@runCatching playerResponse
        }

        val safePlayerResponse = innerTube.player(TVHTML5_SIMPLY_EMBEDDED_PLAYER, videoId, playlistId, null, null).body<PlayerResponse>()
    ...
    suspend fun player(videoId: String, playlistId: String?, client: YouTubeClient, signatureTimestamp: Int?, poToken: String?): Result<PlayerResponse> = runCatching {
    ...
    data class TranscriptCue(val startMs: Long, val durationMs: Long, val text: String)

    suspend fun transcriptCues(videoId: String): Result<List<TranscriptCue>> = runCatching {
        val response = innerTube.getTranscript(WEB, videoId).body<GetTranscriptResponse>()
        response.actions?.firstOrNull()?.updateEngagementPanelAction?.content
            ?.transcriptRenderer?.body?.transcriptBodyRenderer?.cueGroups?.map { group ->
                val renderer = group.transcriptCueGroupRenderer.cues[0].transcriptCueRenderer
                TranscriptCue(
                    startMs = renderer.startOffsetMs,
                    durationMs = renderer.durationMs,
                    text = renderer.cue.simpleText.trim('♪', ' '),
                )
            } ?: emptyList()
    }
            ...
            mutation.payload?.commentEntityPayload?.let { payload ->
                ...
                CommentThreadRenderer(
                    comment = CommentThreadRenderer.Comment(
                        commentRenderer = com.fxzmusic.innertube.models.comment.CommentRenderer(
                            authorText = com.fxzmusic.innertube.models.Runs(
                                runs = listOf(com.fxzmusic.innertube.models.Run(text = payload.author?.displayName ?: "Unknown", navigationEndpoint = null))
                            ),
                            authorThumbnail = com.fxzmusic.innertube.models.Thumbnails(
                                thumbnails = listOf(com.fxzmusic.innertube.models.Thumbnail(url = payload.author?.avatarThumbnailUrl ?: "", width = 0, height = 0))
                            ),
                            contentText = com.fxzmusic.innertube.models.Runs(
                                runs = listOf(com.fxzmusic.innertube.models.Run(text = payload.properties?.content?.content ?: "", navigationEndpoint = null))
                            ),
                            publishedTimeText = com.fxzmusic.innertube.models.Runs(
                                runs = listOf(com.fxzmusic.innertube.models.Run(text = payload.properties?.publishedTime ?: "", navigationEndpoint = null))
                            ),
                            commentId = commentId,
                            voteCount = com.fxzmusic.innertube.models.Runs(
                                runs = listOf(com.fxzmusic.innertube.models.Run(text = likeCount, navigationEndpoint = null))
                            ),
    ...
    suspend fun commentReplies(replyToken: String): Result<Pair<List<com.fxzmusic.innertube.models.comment.CommentRenderer>, String?>> = runCatching {
        ...
        val frameworkReplies = mutations.mapNotNull { mutation ->
            mutation.payload?.commentEntityPayload?.let { payload ->
                ...
                com.fxzmusic.innertube.models.comment.CommentRenderer(
                    authorText = com.fxzmusic.innertube.models.Runs(
                        runs = listOf(com.fxzmusic.innertube.models.Run(text = payload.author?.displayName ?: "Unknown", navigationEndpoint = null))
                    ),
                    authorThumbnail = com.fxzmusic.innertube.models.Thumbnails(
